...
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## 
    ...
    def add_frame_name_to_image(self, image, frame_name):
        cv2.putText(image, frame_name, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
    ...
    def close_window(self, window):
        ...
        for frame_file in self.frame_files:
            ...
            self.width1 = transformed_frame.shape[1]
            self.width_contain1 = self.width1
    ...
    def width_contain(self):
        global width_contain1
        contain_wid =0
        contain_wid = self.width_contain1
